...
class AuthorListViewTest(TestCase):
    ...
    def test_view_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'catalog/author/author_list.html')
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            ...
            BookInstance.objects.create(book=test_book, imprint='Unlikely Imprint, 2016', due_back=return_date,
                                        borrowed=the_borrower, status=status)
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'catalog/book/bookinstance_list_borrowed_user.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_uses_correct_template(self):
        ...
        self.assertTemplateUsed(resp, 'catalog/book/book_renew_librarian.html')
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(resp, reverse('loan-borrowed'))
